...
import { ArrowLeft, Shield, Lock, Eye, CheckCircle, Loader2 } from 'lucide-react'
          ...
          <article className="nyt-article">
            ...
            <div className="nyt-content" style={{textAlign: 'center', marginBottom: '40px'}}>
              <p style={{fontSize: '1.1rem', marginBottom: '20px'}}>
                Prove your identity without revealing any personal information using advanced cryptographic technology.
              </p>
              <p style={{color: 'var(--nyt-gray)'}}>
                Your privacy is protected by mathematical certainty. No data is stored, no identity is revealed.
              </p>
            </div>
            ...
            {!isAuthenticated ? (
              <div style={{textAlign: 'center'}}>
                {!isAuthenticating ? (
                  ...
                  >
                    <Shield style={{marginRight: '8px', width: '20px', height: '20px'}} />
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h3 style={{fontSize: '1rem', fontWeight: '600', marginBottom: '8px'}}>Cryptographic Security</h3>
                  ...
                  <div style={{
                    ...
                    <h3 style={{fontSize: '1rem', fontWeight: '600', marginBottom: '8px'}}>Complete Privacy</h3>
                    <p style={{fontSize: '0.9rem', color: 'var(--nyt-gray)'}}>
                  ...
                  <div style={{
                    ...
                    <h3 style={{fontSize: '1rem', fontWeight: '600', marginBottom: '8px'}}>Anonymous Reviews</h3>
                    <p style={{fontSize: '0.9rem', color: 'var(--nyt-gray)'}}>
              ...
              <div style={{
                ...
                <div style={{display: 'flex', gap: '15px', justifyContent: 'center', flexWrap: 'wrap'}}>
                  <Link href="/" className="nyt-button" style={{backgroundColor: 'var(--nyt-accent)'}}>
                    Continue to Reviews
                  </Link>
                  <Link href="/login" className="nyt-button" style={{backgroundColor: 'var(--nyt-gray)'}}>
                    Access Dashboard
                  </Link>
                </div>
              </div>
